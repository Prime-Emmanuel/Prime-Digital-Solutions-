...
export default function Methodology() {
  return (
    <section id="methodology" className="py-24 md:py-32 relative z-40 bg-[#121214] rounded-t-[3rem] md:rounded-t-[6rem] -mt-12 border-t border-white/10 overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
